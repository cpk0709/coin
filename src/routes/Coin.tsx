...
interface ISpanActiv{
    isActive:boolean;
}

const Tab = styled.span<ISpanActiv>`
    text-align:center;
    text-transform:uppercase;
    font-size:12px;
    font-weight:400;
...
const Coin = () => {
    ...
    // useQuery뒤에 각각 <IInfoData>,<IPriceData> 안 해줘도 작동했음...
    ...
    // infoLoading 이나 tickersLoading 둘중 하나라도 불러오고있으면 true
